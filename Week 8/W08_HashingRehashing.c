...
int main(int argc, char const *argv[]) {
	...
	do {
		...
		if(percentage >= 70){ 
			...
			//moving all data form hashTable to temporary array 
			int *arrTemp; 
			...
			//new size is twice as many as before 
			//with the nearest prime number after the size 
			size *= 2; 
			//looking for prime 
			...
			//hash all data in arrTemp to hashTable 
